...
$I->wantTo('Probar las validaciones de la api');
$I->amGoingTo('Enviar coordenadas de posicion en formato incorrecto');
...
$I->amGoingTo('Enviar coordenadas de posicion sin los parametros necesarios');
$I->amHttpAuthenticated('api', 'api');
$I->sendPost('/position');
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 'bad request'));
$I->seeResponseCodeIs(400);
$I->amGoingTo('Enviar coordenadas de posicion y que la latitud no sea valida');
$I->amHttpAuthenticated('api', 'api');
$I->haveHttpHeader("Content-Type", "application/json");
...
$I->seeResponseCodeIs(400);
$I->amGoingTo('Enviar coordenadas de posicion y que la longitud no sea valida');
$I->amHttpAuthenticated('api', 'api');
$I->haveHttpHeader("Content-Type", "application/json");
